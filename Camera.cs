...
namespace OpenGL_Game
{
    class Camera
    {
        ...
        public Camera()
        {
            ...
            UpdateView();
            projection = Matrix4.CreatePerspectiveFieldOfView(MathHelper.DegreesToRadians(45), 1.0f, 0.1f, 1000f);
        }
        ...
        {
            cameraDirection = Matrix3.CreateRotationX(angle) * cameraDirection;
            UpdateView();
        }
